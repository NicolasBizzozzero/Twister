...
public class ListerCommentaires {
	...
	public static JSONObject listerCommentaires(String clef, String id_message) {
		try {
			...
			return ErrorJSON.serviceRefused("Erreur, ID commentaire trop petit", CodesErreur.ERREUR_ID_TROP_COURT);
		} catch (IDTropGrandException e) {
			return ErrorJSON.serviceRefused("Erreur, ID commentaire trop grand", CodesErreur.ERREUR_ID_TROP_LONG);
		}
	}
